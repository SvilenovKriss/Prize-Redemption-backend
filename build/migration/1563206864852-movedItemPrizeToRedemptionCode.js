...
class movedItemPrizeToRedemptionCode1563206864852 {
    async up(queryRunner) {
        await queryRunner.query('ALTER TABLE `redemption_record` DROP COLUMN `itemPrize`');
        await queryRunner.query('ALTER TABLE `redemption_code` ADD `itemPrize` varchar(255) NOT NULL DEFAULT \'\'');
        await queryRunner.query('ALTER TABLE `redemption_code` ADD `reportedBy` varchar(255) NOT NULL DEFAULT \'\'');
    ...
    async down(queryRunner) {
        ...
        // tslint:disable-next-line: max-line-length
        await queryRunner.query('ALTER TABLE `redemption_record` ADD CONSTRAINT `FK_33fb55decf7f45fec88c8447ad9` FOREIGN KEY (`userId`) REFERENCES `user`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION');
        await queryRunner.query('ALTER TABLE `redemption_code` DROP COLUMN `reportedBy`');
        await queryRunner.query('ALTER TABLE `redemption_code` DROP COLUMN `itemPrize`');
        await queryRunner.query('ALTER TABLE `redemption_record` ADD `itemPrize` varchar(255) NOT NULL DEFAULT \'\'\'\'');
    }
}
exports.movedItemPrizeToRedemptionCode1563206864852 = movedItemPrizeToRedemptionCode1563206864852;
//# sourceMappingURL=1563206864852-movedItemPrizeToRedemptionCode.js.map